...
def suite():
    ...
    suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(DateTimeSimpleTestCase))
    suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(DateTimeAdvancedTestCase))
    suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(DateTimeInnerReferenceTestCase))
    return suite
